...
export class SolicitationComponent implements OnInit {
  ...
  constructor(private globalService: GlobalService, private router: Router, private route: ActivatedRoute, private solicitationsService: SolicitationsService) { }
  ...
  getSolicitation(): void {
    ...
    this.solicitationsService.getSolicitation(solicitationId).subscribe(
